...
contract GMerkleVestorTestMainnet is Test {
	...
	function setUp() public {
		// set token to PWRD
		token = ERC20(address(0xF0a93d4994B3d98Fb5e3A2F90dBc2d69073Cb86b));
		...
		// get pwrd and send to gmerkle
		vm.prank(address(0x359F4fe841f246a095a82cb26F5819E10a91fe0d)); // get pwrd from gro multisig
